...
- Added `v0.1.0-rc.40` release notes with MSI prerelease publishing fixes, stale-installer checksum guards, release provenance manifests, pinned release workflow actions, public signing-readiness gates, shared API contracts and cleaner desktop-session trust diagnostics.
